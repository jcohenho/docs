...
Prisma 4 introduces a number of **breaking changes** when you upgrade from an earlier Prisma version. This guide explains how this upgrade might affect your application and gives instructions on how to handle any changes.
...
We recommend that you first address any Prisma schema validation errors, then pull your database to reflect new Prisma schema capabilities, and finally fix any type errors in the client and validate by running your test suite.
...
### Upgrade your use of the Prisma Client
...
To learn more, see [Default values for required fields on composite types](/concepts/components/prisma-client/composite-types#default-values-for-required-fields-on-composite-types).
...
For a video walkthrough of the upgrade process and examples of upgrade scenarios, see our recorded livestream on upgrading to Prisma 4:
