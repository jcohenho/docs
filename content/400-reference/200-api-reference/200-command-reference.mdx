...
Validates the [Prisma Schema Language](/concepts/components/prisma-schema) of the Prisma schema file.
...
- [Schema prototyping with `db push`](/guides/migrate/prototyping-schema-db-push) <span class="guide"></span>
...
See [Seeding your database](/guides/migrate/seed-database) <span class="guide"></span>
...
- [Migration troubleshooting in production](/guides/migrate/production-troubleshooting#fixing-failed-migrations-with-migrate-diff-and-db-execute) <span class="guide"></span>
...
- [Developing with Prisma Migrate](/guides/migrate/developing-with-prisma-migrate) <span class="guide"></span>
...
If a [schema drift](/concepts/components/prisma-migrate/shadow-database#detecting-schema-drift) is detected while running `prisma migrate dev` using `--create-only`, you will be prompted to reset your database.
...
### <inlinecode>package.json</inlinecode> entry options
