...
| `xml`                | `@db.Xml`                      |
| `inet`               | `@db.Inet`                     |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/concepts/components/prisma-schema/features-without-psl-equivalent#enable-postgresql-extensions-for-native-database-functions). |
...
For more information about using the `multiSchema` feature, refer to [this guide](/guides/other/multi-schema#how-to-include-multiple-database-schemas-in-your-prisma-schema).
