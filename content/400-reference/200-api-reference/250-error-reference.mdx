...
metaTitle: 'Prisma error message reference (Reference)'
...
For more information about how to work with exceptions and error codes, see [Handling exceptions and errors](/concepts/components/prisma-client/handling-exceptions-and-errors).
...
Because Data Proxy connections operate differently from local database connections, error codes are different from regular ones. In general, all Data Proxy-related errors start with `P5xxx`.

#### <inlinecode>P5000</inlinecode>

This request could not be understood by the server

#### <inlinecode>P5001</inlinecode>

This request must be retried

#### <inlinecode>P5002</inlinecode>
...
#### <inlinecode>P5003</inlinecode>

Requested resource does not exist

#### <inlinecode>P5004</inlinecode>

The feature is not yet implemented:

- `beforeExit` event is not yet supported

#### <inlinecode>P5005</inlinecode>

Schema needs to be uploaded

#### <inlinecode>P5006</inlinecode>

Unknown server error

#### <inlinecode>P5007</inlinecode>

Unauthorized, check your connection string

#### <inlinecode>P5008</inlinecode>

Usage exceeded, retry again later

#### <inlinecode>P5009</inlinecode>

Request timed out

#### <inlinecode>P5010</inlinecode>

Cannot fetch data from service

#### <inlinecode>P5011</inlinecode>
...
You see error P5000 when the server cannot understand the request.<br /><br />
