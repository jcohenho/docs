...
> **Note**: For a simple and integrated way to re-create data in your development database as often as needed, check out our [seeding guide](/guides/migrate/seed-database).
...
- You want to [rename a field](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#example-rename-a-field) (by default, Prisma Migrate will drop the existing field)
- You want to [change the direction of a 1-1 relationship](/guides/migrate/developing-with-prisma-migrate/customizing-migrations#example-change-the-direction-of-a-1-1-relation)
...
Refer to [Customizing migrations](/guides/migrate/developing-with-prisma-migrate/customizing-migrations) <span class="guide"></span> for examples.

### Team development

See: [Team development with Prisma Migrate](/guides/migrate/developing-with-prisma-migrate/team-development) <span class="guide"></span>.
...
- [Production troubleshooting](/guides/migrate/production-troubleshooting) <span class="guide"></span>
